...
| [Orchestrator guide](../../forge/openclaw-session-orchestrator-guide.md) | Separates control APIs, lifecycle events, and live transcript transport. The proposed coordinator should keep that distinction. |
