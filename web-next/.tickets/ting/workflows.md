...
**Visual test:** `e2e/visual/ting.visual.spec.ts` → `ting workflows matches web2`
**Status:** FAIL
**Web2 baseline:** `e2e/__screenshots__/web2/ting/workflows.png`
**Web2 source:** `web2/niuu_handoff/ting/design/workflow_builder.jsx`
**Web-next source:** `packages/plugin-ting/src/ui/WorkflowBuilderPage.tsx`, `packages/plugin-ting/src/ui/WorkflowBuilder/`
...
- `packages/plugin-ting/src/ui/WorkflowBuilderPage.tsx` — replace all inline styles with Tailwind
- `packages/plugin-ting/src/ui/WorkflowBuilderPage.test.tsx` — update any snapshot tests
...
- `packages/plugin-ting/src/ui/WorkflowBuilderPage.tsx` — refactor tab button styles
...
- `packages/plugin-ting/src/ui/WorkflowBuilderPage.tsx`
...
- `packages/plugin-ting/src/ui/WorkflowBuilder/WorkflowBuilder.tsx`
- `packages/plugin-ting/src/ui/WorkflowBuilder/GraphView.tsx`
- `packages/plugin-ting/src/ui/WorkflowBuilder/PipelineView.tsx`
- `packages/plugin-ting/src/ui/WorkflowBuilder/LibraryPanel.tsx`
- `packages/plugin-ting/src/ui/WorkflowBuilder/NodeInspector.tsx`
- `packages/plugin-ting/src/ui/WorkflowBuilder/ValidationPanel.tsx`
- `packages/plugin-ting/src/ui/WorkflowBuilder/YamlView.tsx`
...
- `packages/plugin-ting/src/ui/WorkflowBuilderPage.tsx` — add New/Delete buttons
- `packages/plugin-ting/src/ui/useWorkflows.ts` — add create/delete mutations if needed
...
- [ ] Visual regression test `ting workflows matches web2` passes
