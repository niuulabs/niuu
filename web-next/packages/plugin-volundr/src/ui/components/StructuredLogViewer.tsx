        ...
        >
          ...
          <div className="niuu:flex niuu:items-center niuu:gap-2">
            ...
            {showDownload && (
              <button
                type="button"
                className="niuu:rounded-md niuu:border niuu:border-border-subtle niuu:bg-bg-primary niuu:px-3 niuu:py-1.5 niuu:font-mono niuu:text-[11px] niuu:uppercase niuu:tracking-[0.16em] niuu:text-text-secondary niuu:hover:text-text-primary"
                onClick={() =>
