...
const ACTION_BTN =
  ...
  'niuu:hover:border-border niuu:hover:text-text-primary niuu:disabled:opacity-50 niuu:disabled:cursor-not-allowed';
const BTN_PRIMARY =
    ...
    <div className="niuu:p-6 niuu:flex niuu:flex-col niuu:gap-4 niuu:h-full niuu:box-border">
      ...
      <div className="niuu:grid niuu:grid-cols-[220px_1fr] niuu:border niuu:border-border-subtle niuu:rounded-lg niuu:overflow-hidden niuu:flex-1 niuu:min-h-0">
        ...
        >
          ...
          <button
            type="button"
            className={`${CHECK_ROW_BASE} ${selectedRule === null ? 'niuu:bg-bg-elevated' : 'niuu:bg-transparent niuu:hover:bg-bg-tertiary'}`}
          ...
          {rules.map((rule) => {
            ...
            return (
              <button
                key={rule}
                type="button"
                className={`${CHECK_ROW_BASE} ${selectedRule === rule ? 'niuu:bg-bg-elevated' : 'niuu:bg-transparent niuu:hover:bg-bg-tertiary'}`}
        ...
        <div className="niuu:flex niuu:flex-col niuu:overflow-hidden niuu:bg-bg-primary">
          ...
          >
            {filtered.map((issue, i) => (
              <li
                key={`${issue.rule}-${i}`}
                className="niuu:flex niuu:items-start niuu:gap-3 niuu:py-3 niuu:px-4 niuu:border-b niuu:border-b-border-subtle niuu:last:border-b-0"
