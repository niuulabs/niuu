...
const NAV_ITEMS: NavItem[] = [
  { id: 'general', label: 'General', path: '/ting/settings/general' },
  { id: 'dispatch', label: 'Dispatch rules', path: '/ting/settings/dispatch' },
  { id: 'integrations', label: 'Integrations', path: '/ting/settings/integrations' },
  { id: 'personas', label: 'Persona overrides', path: '/ting/settings/personas' },
  { id: 'gates', label: 'Gates & reviewers', path: '/ting/settings/gates' },
  { id: 'flock', label: 'Flock Config', path: '/ting/settings/flock' },
  { id: 'notifications', label: 'Notifications', path: '/ting/settings/notifications' },
  { id: 'advanced', label: 'Advanced', path: '/ting/settings/advanced' },
  { id: 'audit', label: 'Audit Log', path: '/ting/settings/audit' },
];
