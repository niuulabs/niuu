/**
 * General section — read-only key-value display of core Ting service bindings.
 * Matches web2's `ting.general` section.
 */
...
const SERVICE_BINDINGS: KVRowProps[] = [
  { label: 'Service URL', value: 'https://ting.niuu.internal' },
