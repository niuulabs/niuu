...
const SECTION_ITEMS = [
  {
    id: 'general',
    label: 'General',
    description: 'Core service bindings for the Ting coordinator',
  },
  {
    id: 'dispatch',
  ...
  },
  {
    id: 'integrations',
    label: 'Integrations',
    description: 'Trackers, repos, notifiers reachable by the Ting coordinator',
  },
  {
    id: 'personas',
  ...
  },
  {
    id: 'flock',
    label: 'Flock Config',
    description: 'Global defaults for new sagas and runs',
  },
  {
    id: 'notifications',
    label: 'Notifications',
  ...
  return (
    <div className="niuu-p-6 niuu-max-w-[720px]">
      ...
      <p className="niuu-text-sm niuu-text-text-secondary niuu-mb-6">
        Configure your Ting deployment. Select a section from the left to get started.
      </p>
        ...
        {SECTION_ITEMS.map((item) => (
          <li key={item.id}>
            <Link
              ...
              to={`/ting/settings/${item.id}` as any}
