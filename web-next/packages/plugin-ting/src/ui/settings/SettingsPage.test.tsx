...
import { createMockTingSettingsService, createMockAuditLogService } from '../../adapters/mock';
import type { TingPersonaSummary } from '../../ports';

const MOCK_PERSONA_STORE = {
  listPersonas: async () => [] as TingPersonaSummary[],
...
describe('SettingsIndexPage', () => {
  it('renders the index page heading', () => {
    ...
    expect(screen.getByText('Ting Settings')).toBeInTheDocument();
  });
