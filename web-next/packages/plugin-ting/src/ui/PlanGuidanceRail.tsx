 ...
 * Shown on prompt, questions, and draft steps; hidden on running and approved.
 */
...
const HOW_PLAN_WORKS: GuidanceCard = {
  ...
  items: [
    ...
    'Answer clarifying questions to help Ting understand scope and constraints.',
    'Ravns work through the plan together and decompose it into phases and work items.',
    'Review the draft plan and approve or edit phases before committing.',
  ],
};

const WHAT_A_PLANNING_RUN_PRODUCES: GuidanceCard = {
  title: 'What a planning run produces',
  items: [
...
export function PlanGuidanceRail() {
  return (
    ...
    >
      ...
      <GuidanceCard card={WHAT_A_PLANNING_RUN_PRODUCES} />
    </aside>
  );
}
