import { cx, formatClock, formatElapsed, formatKiloWords, normalizeStageLabel, sentenceCase, statusDotClass } from './researchCampaignModel';
import { CitationPopover, ConfidenceBadge, InlineCitation, ResearchMarkdown } from './ResearchCampaignPresentation';
import type { ResearchCampaignPageController } from './useResearchCampaignPage';

export function ResearchCampaignOverview({ controller }: { controller: ResearchCampaignPageController }) {
  const {
    navigate,
    campaign,
    deleteCampaign,
