 ...
 *
 * Pure state machine describing the five steps of the Ting plan wizard.
...
export type PlanStep = 'prompt' | 'questions' | 'running' | 'draft' | 'approved';

export const PLAN_STEPS: PlanStep[] = ['prompt', 'questions', 'running', 'draft', 'approved'];
