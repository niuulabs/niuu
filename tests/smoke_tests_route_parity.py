...
ROUTE_CHECKS: list[RouteCheck] = [
    ...
    RouteCheck(
        "forge/cluster/resources",
        "/api/v1/forge/cluster/resources",
        domain="forge",
        priority="low",
    ),
    RouteCheck("volundr/launch-specs", "/api/v1/volundr/launch-specs", domain="volundr"),
    RouteCheck(
        "volundr/session-definitions",
        "/api/v1/volundr/session-definitions",
        domain="volundr",
    ),
    RouteCheck("volundr/resources", "/api/v1/volundr/resources", domain="volundr"),
    RouteCheck("volundr/prompts", "/api/v1/volundr/prompts", domain="volundr"),
