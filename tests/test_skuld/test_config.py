...
class TestSkuldSettings:
    ...
    def test_defaults(self, monkeypatch):
        ...
        assert s.grok_auth.credential_name == ""
        assert s.grok_auth.seed_path == "/run/secrets/grok/auth.json"
        assert s.grok_auth.writeback_path == "/api/v1/internal/credentials/writeback"
