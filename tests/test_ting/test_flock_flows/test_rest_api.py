...
class TestListFlows:
    def test_empty_list(self) -> None:
        ...
        resp = client.get("/api/v1/ting/flock_flows", headers=_auth_headers())
...
class TestGetFlow:
    def test_get_existing(self) -> None:
        ...
        client = TestClient(_make_app(provider=provider))
        resp = client.get("/api/v1/ting/flock_flows/my-flow", headers=_auth_headers())
        assert resp.status_code == 200
        data = resp.json()
    ...
    def test_get_nonexistent(self) -> None:
        client = TestClient(_make_app())
        resp = client.get("/api/v1/ting/flock_flows/nonexistent", headers=_auth_headers())
...
class TestUpdateFlow:
    def test_update_success(self) -> None:
        ...
        client = TestClient(_make_app(provider=provider))
        resp = client.put(
            "/api/v1/ting/flock_flows/update-me",
    ...
    def test_update_nonexistent_returns_404(self) -> None:
        client = TestClient(_make_app())
        resp = client.put(
            "/api/v1/ting/flock_flows/nonexistent",
...
class TestDeleteFlow:
    def test_delete_success(self) -> None:
        ...
        client = TestClient(_make_app(provider=provider))
        resp = client.delete(
            "/api/v1/ting/flock_flows/delete-me",
            headers=_auth_headers(),
        )
...
class TestFullCRUDCycle:
    def test_create_read_update_delete(self) -> None:
        ...
        # Read
        resp = client.get("/api/v1/ting/flock_flows/lifecycle", headers=headers)
        assert resp.status_code == 200
        ...
        resp = client.put(
            "/api/v1/ting/flock_flows/lifecycle",
            json=updated_body,
            headers=headers,
        )
        assert resp.status_code == 200
        ...
        # Delete
        resp = client.delete("/api/v1/ting/flock_flows/lifecycle", headers=headers)
        assert resp.status_code == 204
