"""Tests for Ting settings compatibility endpoints."""
...
from ting.config import AuthConfig, FlockConfig, NotificationConfig, Settings, WatcherConfig
...
class TestSettingsAPI:
    ...
    def test_get_flock_settings_returns_defaults(self) -> None:
        ...
        response = client.get("/api/v1/ting/settings/flock")
    ...
    def test_get_notifications_returns_frontend_valid_channel(self) -> None:
        ...
        response = client.get("/api/v1/ting/settings/notifications")
    ...
    def test_patch_notification_settings_is_persisted_in_process(self) -> None:
        ...
        patch_response = client.patch(
            "/api/v1/ting/settings/notifications",
            json={
                "channel": "webhook",
                "on_dispatcher_error": False,
                "webhook_url": "https://hooks.example.test/ting",
            },
        )
        get_response = client.get("/api/v1/ting/settings/notifications")
        ...
        assert body["webhook_url"] == "https://hooks.example.test/ting"
    ...
    def test_operator_flock_settings_do_not_overwrite_runtime_flock_config(self) -> None:
        ...
        patch_response = client.patch(
            "/api/v1/ting/settings/flock",
            json={"flock_name": "Core Platform"},
        )
        runtime_response = client.get("/api/v1/ting/flock/config")
