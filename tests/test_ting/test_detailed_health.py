"""Tests for Ting detailed health endpoint."""
...
def client(  # noqa: PLR0913
    ...
    with patch("ting.main.database_pool", _database_pool_stub(mock_pool)):
...
class TestDetailedHealthEndpoint:
    def test_returns_200(self, client: TestClient) -> None:
        response = client.get("/api/v1/ting/health/detailed")
    ...
    def test_database_unavailable_when_pool_missing(self, app, mock_pool) -> None:
        ...
        with patch("ting.main.database_pool", _database_pool_stub(mock_pool)):
            with TestClient(app) as c:
                ...
                response = c.get("/api/v1/ting/health/detailed")
    ...
    def test_response_schema(self, client: TestClient) -> None:
        ...
        data = client.get("/api/v1/ting/health/detailed").json()
