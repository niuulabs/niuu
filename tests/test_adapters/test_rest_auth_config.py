...
def _make_app(settings: Settings) -> FastAPI:
    ...
    app.include_router(create_identity_router(AsyncMock()))
    return app


class TestAuthConfigEndpoint:
    """Tests for GET /api/v1/identity/auth/config."""

    def test_returns_auth_config_when_issuer_set(self):
    ...
    def test_falls_back_to_gateway_issuer_url(self):
    ...
    def test_returns_404_when_no_issuer_configured(self):
    ...
    def test_uses_default_cli_client_id_and_scopes(self):
    ...
    def test_endpoint_requires_no_authentication(self):
