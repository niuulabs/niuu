    ...
    def _task_from_signal(
        ...
        *,
        ...
        context = (
            ...
            "any new tooling. If the investigation is blocked because the toolbox lacks "
            "a reusable instrument, call build_tool with a manifest, declared reach, "
            "and canary input; then use the newly registered tool before deciding. "
