...
BUILTIN_TOOLS: dict[str, BuiltinToolDef] = {
    ...
    "workflow_execution_expand": BuiltinToolDef(
        adapter="ravn.adapters.tools.delivery.WorkflowExecutionExpandTool",
    ...
    "workflow_execution_reconcile": BuiltinToolDef(
        adapter="ravn.adapters.tools.delivery.WorkflowExecutionReconcileTool",
        groups=frozenset({"delivery"}),
        required_context=frozenset({"workflow_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["workflow_execution"]},
    ),
    "workflow_execution_retry": BuiltinToolDef(
        adapter="ravn.adapters.tools.delivery.WorkflowExecutionRetryTool",
        groups=frozenset({"delivery"}),
        required_context=frozenset({"workflow_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["workflow_execution"]},
    ),
    "workflow_execution_cancel": BuiltinToolDef(
        adapter="ravn.adapters.tools.delivery.WorkflowExecutionCancelTool",
        groups=frozenset({"delivery"}),
        required_context=frozenset({"workflow_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["workflow_execution"]},
    ),
    "workflow_execution_message": BuiltinToolDef(
        adapter="ravn.adapters.tools.delivery.WorkflowExecutionMessageTool",
        groups=frozenset({"delivery"}),
        required_context=frozenset({"workflow_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["workflow_execution"]},
    ),
    "workflow_execution_complete": BuiltinToolDef(
        adapter="ravn.adapters.tools.delivery.WorkflowExecutionCompleteTool",
        groups=frozenset({"delivery"}),
        required_context=frozenset({"workflow_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["workflow_execution"]},
    ),
    "workflow_execution_record_integration": BuiltinToolDef(
        adapter=("ravn.adapters.tools.delivery.WorkflowExecutionRecordIntegrationTool"),
        groups=frozenset({"delivery"}),
        required_context=frozenset({"workflow_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["workflow_execution"]},
    ),
