...
BUILTIN_TOOLS: dict[str, BuiltinToolDef] = {
    ...
    "developer_execution_expand": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionExpandTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_reconcile": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionReconcileTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_retry": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionRetryTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_cancel": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionCancelTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_message": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionMessageTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_complete": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionCompleteTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_record_integration": BuiltinToolDef(
        adapter=("ravn.adapters.tools.developer_delivery.DeveloperExecutionRecordIntegrationTool"),
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "developer_execution_wait_delivery": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeveloperExecutionWaitDeliveryTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"developer_execution"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["developer_execution"]},
    ),
    "delivery_workspace": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeliveryWorkspaceTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"delivery_service"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["delivery_service"]},
    ),
    "delivery_forge": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeliveryForgeTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"delivery_service"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["delivery_service"]},
    ),
    "delivery_evidence": BuiltinToolDef(
        adapter="ravn.adapters.tools.developer_delivery.DeliveryEvidenceTool",
        groups=frozenset({"developer_delivery"}),
        required_context=frozenset({"delivery_service"}),
        kwargs_fn=lambda _s, ctx: {"service": ctx["delivery_service"]},
    ),
