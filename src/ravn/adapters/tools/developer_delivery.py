...
from ravn.domain.developer_delivery import DeveloperExecutionToolPort
...
class _DeveloperExecutionTool(ToolPort):
    operation = ""

    def __init__(self, *, service: DeveloperExecutionToolPort) -> None:
        self._service = service

    @property
    def name(self) -> str:
        return f"developer_execution_{self.operation}"
...
class DeveloperExecutionReconcileTool(_DeveloperExecutionTool):
    operation = "reconcile"


class DeveloperExecutionRetryTool(_DeveloperExecutionTool):
    operation = "retry"


class DeveloperExecutionCancelTool(_DeveloperExecutionTool):
    operation = "cancel"


class DeveloperExecutionMessageTool(_DeveloperExecutionTool):
    operation = "message"


class DeveloperExecutionCompleteTool(_DeveloperExecutionTool):
    operation = "complete"


class DeveloperExecutionRecordIntegrationTool(_DeveloperExecutionTool):
    operation = "record_integration"


class DeveloperExecutionWaitDeliveryTool(_DeveloperExecutionTool):
