...
class RavnDeveloperA2AGateway:
    ...
    def __init__(
        ...
        *,
        ...
        developer_execution_base_url: str = "",
    ) -> None:
        self._task_tool = task_tool
        self._developer_execution_base_url = developer_execution_base_url.rstrip("/")
    ...
    async def launch_child(
        ...
        metadata = {
            **request.metadata,
            ...
            "deliveryContract": "niuu.developer-child.v1",
        }
        ...
        if self._developer_execution_base_url:
            metadata["developerExecution"] = {
...
class ConfiguredRavnDeveloperA2AGateway(RavnDeveloperA2AGateway):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            developer_execution_base_url=base_url,
        )
